...
const tiers: Record<string, Tier> = {
  ...
  ...service("MeService", {
    ...
    ListSubscriptionProfiles: "authenticated",
    GetSubscriptionProfile: "authenticated",
    CreateSubscriptionProfile: "authenticated",
    SaveSubscriptionDraft: "authenticated",
    PreviewSubscriptionProfile: "authenticated",
    PublishSubscriptionProfile: "authenticated",
    UpdateSubscriptionProfile: "authenticated",
